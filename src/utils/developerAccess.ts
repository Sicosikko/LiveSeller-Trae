...
// Configuração para habilitar o preview do SaaS
const enableSaasPreview = true;
...
/**
 * Verifica se o preview do SaaS está habilitado
 * @returns Boolean indicando se o preview do SaaS está habilitado
 */
export const isSaasPreviewEnabled = (): boolean => {
  return enableSaasPreview;
};
