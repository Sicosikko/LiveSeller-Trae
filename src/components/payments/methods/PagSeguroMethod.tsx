...
const PagSeguroMethod: React.FC<PaymentMethodProps> = ({ enabled, configured, onToggle }) => {
  return (
    <Card>
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription>Gateway brasileiro</CardDescription>
          </div>
          <Switch 
            checked={enabled} 
      ...
      <CardContent className="pb-2">
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor="pagseguro-key">Token de Acesso</Label>
            <Input 
              id="pagseguro-key" 
...
export default PagSeguroMethod;
