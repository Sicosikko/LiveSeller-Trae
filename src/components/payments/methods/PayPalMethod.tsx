...
const PayPalMethod: React.FC<PaymentMethodProps> = ({ enabled, configured, onToggle }) => {
  return (
    <Card>
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription>Pagamentos internacionais</CardDescription>
          </div>
          <Switch 
            checked={enabled} 
      ...
      <CardContent className="pb-2">
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor="paypal-key">ID do Cliente</Label>
            <Input 
              id="paypal-key" 
              placeholder="ID do Cliente PayPal" 
              disabled={!enabled} 
            />
          </div>
        </div>
