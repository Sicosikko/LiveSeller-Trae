...
const MercadoPagoMethod: React.FC<PaymentMethodProps> = ({ enabled, configured, onToggle }) => {
  return (
    <Card>
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription>Gateway latino-americano</CardDescription>
          </div>
          <Switch 
            checked={enabled} 
      ...
      <CardContent className="pb-2">
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor="mercadopago-key">Access Token</Label>
            <Input 
              id="mercadopago-key" 
              placeholder="Access Token Mercado Pago" 
              defaultValue="APP_USR-xxxxx-xxxxx-xxxxx-xxxxx"
              type="password"
              disabled={!enabled} 
            />
          </div>
...
export default MercadoPagoMethod;
